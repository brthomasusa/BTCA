...
{
    public static class BTCASampleData
    {
        public static IEnumerable<DailyLog> LoadDailyLogTable()
        {
        ...
        public static IEnumerable<DailyLogDetail> LoadDailyLogDetailTable()
        {             
        ...
        public static IEnumerable<AppUser> LoadAppUserTable()
        {
        ...
        public static IEnumerable<AppRole> LoadAppRoleTable()
        {
        ...
        public static IEnumerable<DutyStatus> LoadDutyStatusTable()
        {
            var data = new List<DutyStatus>
            {
                ...
                new DutyStatus {DutyStatusID = 2, ShortName = "Sleeper", LongName = "Sleeper Berth", CreatedBy = "admin", CreatedOn = DateTime.Now, UpdatedBy = "admin", UpdatedOn = DateTime.Now},
        ...
        public static IEnumerable<DutyStatusActivity> LoadDutyStatusActivityTable()
        {
        ...
        public static IEnumerable<Company> LoadCompanyTable()
        {
        ...
        public static IEnumerable<StateProvinceCode> LoadStateProvinceCodeTable()
        {
        ...
        public static IEnumerable<Address> LoadCompanyAddresses()
        {
